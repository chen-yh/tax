    ...
    <div class="bg-hui-info">
     <div class="company-info">
      ...
      <div class="company-info">
        ...
        <dd><input type="text" name="" v-model="tsile"></dd>
       </dl>
       <dl>
       ...
       <dl>
        ...
        <dd><input type="text" name="" v-model="refundTax"> 元</dd>
       </dl>
      </div>
      <div class="company-info">
       <dl>
      ...
      <div class="bg-hui-info">
       <div class="company-info">
        ...
        <div class="company-info">
         <dl>
          <dt>备 份：</dt>
          <dd><input type="text" name="" v-model="remarks"></dd>
         </dl>
         <dl>
          <dt>&nbsp;</dt>
          <dd>&nbsp;</dd>
     ...
     <h2 class="title">主要原材料采购渠道情况</h2>
      <div class="bg-hui-info">
       <div class="company-info">
        ...
        <div style="margin-left:10px; margin-top:10px;">备份：
  ...
  methods: {
    ...
    submitUser (datas) {
      ...
      let parames = {
        ...
        'idCard': this.idCard || '',   
        // | 公司营业执照
        'businessLice': this.businessLice || ''
      }
      let parames1 ={
        'factoryInside': this.factoryInside || '',
      ...
      if (this.foundTime === '') {
        this.$alert('提示信息', '成立时间不能为空', {
          confirmButtonText: '确定'
        })
      }
      if (this.mainProduct === '') {
        this.$alert('提示信息', '主营产品不能为空', {
          confirmButtonText: '确定'
        })
      }
      if (this.productImg === '') {
        this.$alert('提示信息', '主营产品图片不能为空', {
          confirmButtonText: '确定'
        })
      }
      if (this.exportRank === '') {
      ...
      // 条件end
      // 新增客户
      console.log(parames,parames1,parames2,this.tsile)
