<template>
    <div class="details">
        <div class="hearder">
            <p style="color: #A9A9A9" > 当前位置 > 首页 > 账户管理 > 编辑账户 </p>
                        ...
                        <table border="0" align="center" style="margin-top: 50px">
                            <tr>
                                ...
                                <td align="center" height="40px" width="400px">
                                    <input type="text" class="username" placeholder="请输入用户名" style="height: 40px; width: 280px" v-model="userName" disabled="true">
                                </td>
                                <td align="left">
                            ...
                            <tr>
                                ...
                                <td align="center" height="40px" >
                                    <input type="text" class="password" placeholder="请输入密码" style="height: 40px; width: 280px" @focus="passWord()" v-model="password">
                                </td>
                                <td align="left">
                            ...
                            <tr>
                                ...
                                <td align="center" height="40px">
                                    <input type="text" class="realname" placeholder="请输入账户名" style="height: 40px; width: 280px" @focus="realName()" v-model="realname">
                                </td>
                                <td align="left">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td align="center" height="40px">
                                    <select style="height: 40px; width: 280px" v-model="assignRolesModel" name="assignRoles" id="assignRoles"><option v-for="da in rolesData"  v-bind:value="da.id" v-bind:key="da.id"> {{ da.roledesc }}</option></select>
                                </td>
                                <td align="center">
                                </td>
                            </tr>
                             ...
                             <tr>
                                ...
                                <td align="left" height="40px">
                                    <button style="background-color: #A9A9A9;height: 40px; width: 180px; color: #FFFFFF; font-size: 15px" @click="cancle ()"> 取消 </button>
                                </td>
                                <td align="left">
                                    <button style="background-color:  #FF8C00; height: 40px; width: 180px; color: #FFFFFF; font-size: 15px" @click="getEditData ()"> 确认并提交 </button>
                                    <!-- oowayRoleManagement -->
                                </td>
                            </tr>
                        </table>
  ...
  methods: {
    ...
    getAllRole () {
      ...
      this.$http.post('/api/sys/role/all', {
        ...
        _this.rolesData = res.data.result
    ...
    getDatas () {
      ...
      _this.thisId = thisId
      this.$http.get('/api/sys/user/info?id=' + thisId, {
      }).then(function (res) {
    ...
    getEditData () {
      ...
      let deptno = $('#subordinateDepartments option:selected').val()
      let status = $('input:radio[name="radio"]:checked').val()
      let mId = _this.thisId
