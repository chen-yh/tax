        ...
        <div class="view">
           ...
           <!--          <div class="choose">
                    ...
                    <div class="choose choose-remember">
                        ...
                        <router-link :to="{name:'outForgetPassword'}" class="forget-password">忘记密码?</router-link>
                    </div>
                    <div class="tips"></div>
                    ...
                    <div class="choose-submit">
                        <p><span>还没账号?</span><router-link :to="{name:'outRegister'}" class="immediately">立即注册</router-link></p>
                    </div>
                </div>
            </div>
        </div>
      ...
      if (userName === '' || userName === '请输入用户名') {
        ...
        this.$http.post('/api/user/login', {
          ...
          if (res.data.msg === '登陆成功') {
              localStorage.setItem('outsideUserLoginMsg', JSON.stringify(res.data.result))
              _this.$router.push({
                path: '/outindex'
              })
          }else {
