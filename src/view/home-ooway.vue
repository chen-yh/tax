    ...
    <div class="wrap">
        <div class="view">
            <div class="view-logo">
                ...
                <div class="logo-left">
                    <img src="../../static/img/logo_denglu2.png" alt="">
                </div>
                <div class="logo-right">
                    ...
                    <!-- <div class="choose choose-remember">
                        ...
                        <router-link :to="{name:'oowayForgetPassword'}" class="immediately"> 忘记密码? </router-link>
                    </div> -->
                    <div class="tips"></div>
...
<!--                     <div class="choose-submit">
                        <p><span>还没账号?</span><router-link :to="{name:'oowayRegister'}" class="immediately">立即注册</router-link></p>
                    </div> -->
                </div>
            </div>
        </div>
        ...
        methods: {
            ...
            loginSubmit () {
                ...
                if(userName == '' || userName === '请输入用户名') {
                    ...
                    var _this = this
                    this.$http.post('/api/sys/user/login', {
                        username: userName,
                        password: passWord,
                    }).then(function (res) {
                    if (res.data.msg === '登陆成功') {
                        localStorage.setItem('oowayUserLoginMsg', JSON.stringify(res.data.result))
                        _this.$router.push({path: '/oowayIndex',query: {'info': res.data.info}})
                    }else {
                        alert(res.data.msg)
                    }
