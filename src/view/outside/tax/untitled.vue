       ...
       <div class="bgwhite">
         ...
         <div class="goods-form">
           ...
           <div class="company-info">
             ...
             <dl>
               ...
               <dd><input type="date" name="" v-model="taxAllInfo2.declareTime">
                <div>
         ...
         <div id="goods">
          <!--报关单商品展示-->
             <div v-for="p in productsList">
               <div class="tit2">
                  <h3><span class="red">*</span> 报关单商品11 111<img src="static/img/msg_3.png" class="icon-del"> <input type="hidden" :value="p.id"/></h3>
               ...
               <div class="goods2">
                 ...
                 <div class="company-info">
                   <dl>
                     <dt>商品总价：</dt>
                     <dd><span class="red" style="line-height:40px;" id="totalPrice">{{p.totalPrice}} 美元</span>
                     </dd>
                   </dl>
                   <dl>
                     <dt> </dt>
             ...
             <div>
               ...
               <div class="goods1">
                 <div class="company-info">
                   <dl>
                     <dt><span class="red">*</span> 出口商品名称：</dt>
                     <dd><input type="text" name="" v-model="taxAllInfo2.productName">
                      <div>
                         <span v-if="taxAllInfo2.productName==''">不能为空</span>
                       </div>
                     </dd>
                   </dl>
                   <dl>
                     <dt><span class="red">*</span> 出口商品SH编码：</dt>
                     <dd><input type="text" name="" v-model="taxAllInfo2.hsNumber">
                      <div>
                       <span v-if="taxAllInfo2.hsNumber==''">不能为空</span>
                     </div>
                     </dd>
                   </dl>
                 </div>
                 <div class="company-info">
                   ...
                   <dl>
                     <dt><span class="red">*</span> 退税率：</dt>
                     <dd><input type="text" name="" v-model="taxAllInfo2.rate"> %
                      <div>
                        <span v-if="!/^[0-9].*$/.test(taxAllInfo2.rate)">请输入数字格式</span>
                         <span v-else-if="taxAllInfo2.rate==''">不能为空</span>
                       </div>
                     </dd>
                   </dl>
                 </div>
                 ...
                 <div class="company-info">
                   <dl>
                     <dt>商品总价：</dt>
                     <dd><span class="red" style="line-height:40px;" id="totalPrice">{{taxAllInfo2.quantity*taxAllInfo2.price || 0}} 美元</span>
                     </dd>
                   </dl>
                   <dl>
                     <dt> </dt>
         ...
         <div class="company-info">
           ...
           <dl>
             ...
             <dd><input type="text" name="" v-model="taxAllInfo2.huilv">
             <div>
                <span v-if="!/^[0-9].*$/.test(taxAllInfo2.huilv)">请输入数字格式</span>
                 <span v-else-if="taxAllInfo2.huilv==''">不能为空</span>
               </div>
             </dd>
           </dl>  
         </div>
         ...
         <div class="company-info">
          <dl>
             ...
             <dd style="line-height:38px; font-weight:bold;"><span class="red">{{isNaN(totalFin)?0:totalFin}} 元</span></dd>
           </dl>
           <dl>
             <dt>&nbsp;</dt>
             <dd>&nbsp;</dd>
         ...
         <div class="company-info">
           <dl>
             ...
             <dd style="line-height:38px;">{{taxAllInfo2.invoiceQuantity}}</dd>
           </dl>
           <dl>
             <dt> <span class="red">*</span> 发票总金额： </dt>
             <dd style="line-height:38px;">{{taxAllInfo2.totalInvoice}} </dd>
           </dl>
         </div>
         <!--票据信息-->
          <h2 class="tit-hui">
         ...
         <div class="piaoju" style="position: relative;">
          <dl>
           ...
           <dd>
            <div class="pic1"><a :href="imgsSrc1" target="_blank"><img :src="imgsSrc1 || taxAllInfo2.customsDeclImg || '/static/img/def_7.png'"></a></div>
          ...
          <dl>
           ...
           <dd>
            <div class="pic-shouhui">
              ...
              <a :href="earningsVal.earningsImg"><img :src="earningsVal.earningsImg || taxAllInfo2.earningsImg ||  '/static/img/def_7.png'"></a></div>
            <!-- <div class="btn-file">
          ...
          <dl>
           ...
           <dd>
            <div class="pic2">
              <a :href="imgsSrc3 || '/static/img/def_7.png'"><img :src="imgsSrc3  || taxAllInfo2.transferImg || '/static/img/def_7.png'"></a>
            </div>
            <!-- <div class="btn-file">
          ...
          <dl>
           ...
           <dd class="fapiao voice">
            <div class="pic3">
              <span  v-if="receiptImgss.length>=1"><img :src="r" v-for="r in receiptImgss">  <span class="del2"> X </span>
              </span>
              <span  v-else><img src="/static/img/def_7.png"></span>
...
export default({
  ...
  computed: {
    totalFin: function () {
      return parseInt(this.taxAllInfo2.declareSum) * parseInt(this.taxAllInfo2.rate) * parseInt(this.taxAllInfo2.huilv) * .01
    }
  ...
  methods: {
    ...
    addGoods () {
      ...
      // 调添加商品的接口
      this.$http.post('/api/product/add', {'name': _this.taxAllInfo2.productName, 'hsNumber': _this.taxAllInfo2.hsNumber, 'price': _this.taxAllInfo2.price, 'rate': _this.taxAllInfo2.rate, 'quantity': _this.taxAllInfo2.quantity, 'totalPrice': tol})
        .then(res => {
      ...
      if (this.taxAllInfo2.invoiceMoney && !isNaN(this.taxAllInfo2.invoiceMoney)) {
        ...
        .then(res => {
          ...
          `
            ...
            // 计算发票总金额
            _this.totalInvoice += Number(_this.taxAllInfo2.invoiceMoney)
            // 计算发票数量
    ...
    goApp2 () {
      ...
      // } else {
        ...
        let params = {
          ...
          'ids': _this.ids || _this.saveProductIds(),
    ...
    allInfos () {
      ...
      this.allInfo = {
          ...
          'refundTax': this.totalFin || this.taxAllInfo2.totalFin,
          ...
          'invoiceQuantity': this.invoiceQuantity || this.taxAllInfo2.invoiceQuantity,
          'totalInvoice' : this.totalInvoice || this.taxAllInfo2.totalInvoice,
      ...
      this.$http.get('/api/refundapply/select/bycondition?id=' + id)
        .then(res => {
          if (res.data.status === 200 && res.data.refundApply) {
            ...
            console.log('mmm', _this.receiptImgss.length>=1)
          }
        })
    },
    // 待提交
