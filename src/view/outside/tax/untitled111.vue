    ...
    <div>
       ...
       <div class="bgwhite">
         ...
         <div class="goods-form">
           ...
           <div class="company-info">
            <dl>
               <dt><span class="red">*</span> <label><input type="radio" v-model="userType" name="userType" value="0"> 平台推荐出口企业：</label></dt>
               <dd>
           ...
           <div class="company-info">
            <dl>
               <dt><label><input type="radio" v-model="userType" name="userType" value="1"> 自有出口企业：</label></dt>
               <dd>
          ...
          <dl>
           ...
           <dd class="fapiao voice">
            <div class="pic3">
              ...
              <img src="r" v-for="r in receiptSrc">
            </div>
...
export default({
  data () {
    return {
      // 新增'',   
      hsNumber: JSON.parse(window.localStorage.getItem('products')) ? JSON.parse(window.localStorage.getItem('products')).hsNumber : '',
      price: JSON.parse(window.localStorage.getItem('products'))? JSON.parse(window.localStorage.getItem('products')).price : 0,  
      rate: JSON.parse(window.localStorage.getItem('products'))?JSON.parse(window.localStorage.getItem('products')).rate : 0,
      quantity: JSON.parse(window.localStorage.getItem('products'))?JSON.parse(window.localStorage.getItem('products')).price : 0,
      // 新增商品字段end
      invoiceQuantity: 0,
      fNum: 1,
      invoiceMoney: JSON.parse(window.localStorage.getItem('invoice')) ? JSON.parse(window.localStorage.getItem('invoice')).invoiceMoney : 0,
      allInfo: {},
      ...
      prodectName: '',
      productName: JSON.parse(window.localStorage.getItem('products')) ? JSON.parse(window.localStorage.getItem('products')).name : '',
      shNum: '',
      productPrice: '',
      taxR: '',
      // 收汇字段
      ...
      createTime: JSON.parse(window.localStorage.getItem('invoice')) ? JSON.parse(window.localStorage.getItem('invoice').createTime) : '',
      invoiceNumber: JSON.parse(window.localStorage.getItem('invoice')) ? JSON.parse(window.localStorage.getItem('invoice').invoiceNumber) : '',
      fapiao: '',
      // invoiceQuantity: '',
      // 总发票
      totalInvoice: 0,
  ...
  created () {
    ...
    if (!this.$route.query.id && !this.addGoodsData) {
    
       window.localStorage.removeItem('products')
    }
    if (!this.$route.query.id && !this.invoiceDatas) {
  ...
  methods: {
    ...
    allInfos () {
      this.allInfo = {
          ...
          'receiptImg': this.imgsSrc4File.slice(0, this.imgsSrc4File.length-1),
    ...
    imgSrc4 (_imgSrc) {
      ...
      this.imgsSrc4File += this.imgsSrc4+','
    },
    // 去增加自有客户
    goAddMyUser () {
      this.$router.push({
