<template>
    <div class="apply">
       ...
       <div class="bgwhite">
         ...
         <div class="goods-form">
           <div class="company-info">
             <dl>
               ...
               <dd><input type="text" name="" v-model="taxAllInfo2.contract" @focus="textFocus()">
               <div>
                 <span v-if="taxAllInfo2.contract==''">不能为空</span>
               </div>
               </dd>
             </dl>
             <dl>
               <dt><span class="red">*</span> 报关单号：</dt>
               <dd><input type="text" name="" v-model="taxAllInfo2.customsDecl">
                 <div>
                   <span v-if="taxAllInfo2.customsDecl==''">不能为空</span>
                 </div>
               </dd>
             </dl>
           </div>
           <div class="company-info">
             <dl>
               ...
               <dd><input type="text" name="" v-model="taxAllInfo2.passState">
                <div>
                   <span v-if="taxAllInfo2.passState==''">不能为空</span>
                 </div>
               </dd>
             </dl>
             <dl>
               ...
               <dd>
                <input type="date" name="" v-model="taxAllInfo2.declareTime" v-if="!taxAllInfo2.declareTime">
                <input type="text" name="" v-model="taxAllInfo2.declareTime" v-if="taxAllInfo2.declareTime"> <span @click="clearDate()" class="clearDate" v-if="taxAllInfo2.declareTime"><img src="static/img/msg_3.png"></span>
                <div>
                   <span v-if="taxAllInfo2.declareTime==''">不能为空</span>
                 </div>
               </dd>
             </dl>
           </div>
           <div class="company-info">
            <dl>
             ...
             <dl>
               ...
               <dd><input type="text" name="" v-model="taxAllInfo2.declareSum" style="width:115px;"> 美元<span ></span>
                <div>
                  <span v-if="!/^[0-9].*$/.test(taxAllInfo2.declareSum)">请输入数字格式</span>
                  <span v-else-if="taxAllInfo2.declareSum==''">不能为空</span>
                 </div>
               </dd>
             </dl>
           </div>
         ...
         <div id="goods">
          <!--报关单商品展示-->
             <div v-for="p in productsList">
               <div class="tit2">
                  <h3>
                    <span class="red">*</span> 报关单商品
                    <img src="static/img/msg_3.png" class="icon-del"> 
                    <input type="hidden" :value="p.id" />
                    <input type="hidden" :value="p.totalPrice" />
                    <input type="hidden" :value="p.rate" />
                  </h3>
               ...
               <div class="goods2">
                 ...
                 <div class="company-info">
                   <dl>
                     <dt>商品总价：</dt>
                     <dd><span class="red" style="line-height:40px;" id="totalPrice1">{{p.totalPrice}} 美元</span>
                     </dd>
                   </dl>
                   <dl>
                     <dt> </dt>
             ...
             <div>
               ...
               <div class="goods1">
                 <div class="company-info">
                   <dl>
                     <dt><span class="red">*</span> 出口商品名称：</dt>
                     <dd style="width:40%;"><input type="text" name="" v-model="productName">
                      <div>
                   ...
                   <dl>
                     <dt><span class="red">*</span> 出口商品SH编码：</dt>
                     <dd><input type="text" name="" v-model="hsNumber" @blur="getRate(hsNumber)">
                      <div>
                 ...
                 <div class="company-info">
                   <dl>
                     <dt><span class="red">*</span> 商品单价：</dt>
                     <dd><input type="text" name="" v-model="taxAllInfo2.price" @focus="textFocus()"> 美元
                      <div>
                        <span v-if="!/^[0-9].*$/.test(taxAllInfo2.price)">请输入数字格式</span>
                         <span v-else-if="taxAllInfo2.price==''">不能为空</span>
                       </div>
                     </dd>
                   </dl>
                   <dl>
                 ...
                 <div class="company-info">
                   <dl>
                     <dt><span class="red">*</span> 商品数量：</dt>
                     <dd><input type="text" name="" v-model="taxAllInfo2.quantity">
                      <div>
                        <span v-if="!/^[0-9].*$/.test(taxAllInfo2.quantity)">请输入数字格式</span>
                       <span v-else-if="taxAllInfo2.quantity==''">不能为空</span>
                     </div>
                     </dd>
                   </dl>
                   <dl>
                 ...
                 <div class="company-info">
                   <dl>
                     <dt>商品总价：</dt>
                     <dd><span class="hui" style="line-height:40px;" id="totalPrice">{{isNaN(goodsMoney)?0:goodsMoney}} 美元</span>
                     </dd>
                   </dl>
                   <dl>
                     <dt> </dt>
         ...
         <div class="company-info">
           <dl>
             ...
             <dd><input type="text" name="" v-model="taxAllInfo2.earnings"> 美元<img src="../../../assets/img/icon-del.png" class="icon" @click="delVal()">
              <div>
                <span v-if="!/^[0-9].*$/.test(taxAllInfo2.earnings)">请输入数字格式</span>
                 <span v-else-if="taxAllInfo2.earnings==''">不能为空</span>
               </div>
             </dd>
           </dl>
           <dl>
         ...
         <div class="company-info">
           <dl>
             ...
             <dd><input type="text" name="" v-model="taxAllInfo2.settlement"> 元
              <div>
                <span v-if="!/^[0-9].*$/.test(taxAllInfo2.settlement)">请输入数字格式</span>
                 <span v-else-if="taxAllInfo2.settlement==''">不能为空</span>
               </div>
             </dd>
           </dl>
           <dl>
             <dt><span class="red">*</span> 汇率：</dt>
             <dd><input type="text" name="" v-model="exchangeRate" >
             <div>
                <span v-if="!/^[0-9].*$/.test(exchangeRate)">请输入数字格式</span>
                 <span v-else-if="exchangeRate==''">不能为空</span>
               </div>
             </dd>
           </dl>  
         </div>
         ...
         <div class="company-info">
           <dl>
             ...
             <dd><input type="text" name="" v-model="taxAllInfo2.invoiceCode"></dd>
           </dl>
           <dl>
             <dt>&nbsp;</dt>
             <dd>&nbsp;</dd>
         ...
         <!--保存的发票-->
        <!--  <div id="addFapiaos1" class="add-fapiao">
           <div v-for="i in invoiceInfoList">
              发票号码：{{i.invoiceNumber}}&nbsp; &nbsp;发票金额：{{i.invoiceMoney}} <img src="static/img/msg_3.png" class="icon-del"><input type="hidden" :value="i.id">
           </div>
         </div> -->
         <!--保存的发票end -->
         <div id="addFapiaos" class="add-fapiao">
            <div v-for="i in invoiceInfoList">
              发票号码：{{i.invoiceNumber}}&nbsp; &nbsp;发票金额：{{i.invoiceMoney}} 
              <img src="static/img/msg_3.png" class="icon-del">
              <input type="hidden" :value="i.id">
              <input type="hidden" id="v2" :value="i.invoiceMoney">
           </div>
         </div>
         <div class="add-fapiao">
           <div>
            <span class="red">*</span> 开票日期：<input type="date" name="" v-model="taxAllInfo2.createTime"> &nbsp; &nbsp;
              <span class="red">*</span> 发票号码：<input type="text" name="" v-model="taxAllInfo2.invoiceNumber">&nbsp; &nbsp;<span class="red">*</span> 发票金额：<input type="text" name="" v-model="taxAllInfo2.invoiceMoney" class="fapiao">
           </div>
           <div class="btn-orange-small" id="add-fapiao" @click="addFapiao()" style="width:160px;">新增发票号码及金额</div>
         </div>
         <div class="company-info">
           <dl>
             <dt>
             ...
             <dd style="line-height:38px;">{{invoiceQuantity?invoiceQuantity:taxAllInfo2.invoiceQuantity}}</dd>
           </dl>
           <dl>
         ...
         <div class="piaoju" style="position: relative;">
          <dl>
           ...
           <dd>
            <div class="pic1">
              <!-- <a :href="imgsSrc1 || taxAllInfo2.customsDeclImg || '/static/img/def_7.png'" target="_blank"> -->
               <a :href="taxAllInfo2.customsDeclImg?taxAllInfo2.customsDeclImg:imgsSrc1" target="_blank"><img :src="imgsSrc1 || taxAllInfo2.customsDeclImg || '/static/img/def_7.png'"></a>
            </div>
          ...
          <dl>
           ...
           <dd>
            <div class="pic-shouhui">
              <!--v-if="showImg1"    v-if="showImg2"-->
              <!-- <a :href="imgsSrc2"><img :src="imgsSrc2 || '/static/img/def_7.png'" ></a> -->
              <a :href="taxAllInfo2.earningsImg?taxAllInfo2.earningsImg:imgsSrc2"  target="_blank"><img :src="imgsSrc2 || taxAllInfo2.earningsImg ||  '/static/img/def_7.png'"></a></div>
            <!-- <div class="btn-file">
          ...
          <dl>
           ...
           <dd>
            <div class="pic2">
              <a :href="taxAllInfo2.transferImg?taxAllInfo2.transferImg:imgsSrc3 || '/static/img/def_7.png'"  target="_blank"><img :src="imgsSrc3  || taxAllInfo2.transferImg || '/static/img/def_7.png'"></a>
            </div>
          ...
          <dl>
           ...
           <dd class="fapiao voice">
            <div class="pic3">
              <span v-if="receiptImgss.length>=1" v-for="r in receiptImgss">
                <a :href="r"  target="_blank">
                  <img :src="r" > 
                </a>
                <span class="del2"> X </span>
              </span>
              <span v-if="receiptImgss.length==0"><img src="/static/img/def_7.png"></span>
...
export default({
  data () {
    return {
      ...
      invoiceQuantity: 0,
      fNum: 1,
      // window.localStorage.getItem('invoice') ? JSON.parse(window.localStorage.getItem('invoice')).invoiceMoney : 0
      invoiceMoney: 0,
      allInfo: {},
      contract: this.taxAllInfo2 ? this.taxAllInfo2.contract : '44',
  ...
  computed: {
    // totalFin: function () {
    //   return parseInt(this.taxAllInfo2.declareSum) * parseInt(this.rate) * parseInt(this.taxAllInfo2.exchangeRate) * .01
    // },
    goodsMoney: function () {
      return parseInt(this.taxAllInfo2.quantity) * parseInt(this.taxAllInfo2.price)
    }
    // this.totalFin = this.declareSum * this.rate * this.rate * .01
  },
  watch: {
    // 监测商品总价
    // price: function () {
    //   return this.totalPrice = this.taxAllInfo2.price * this.taxAllInfo2.quantity
    // },
    // rate: function () {
    //   return this.totalPrice = this.taxAllInfo2.price * this.taxAllInfo2.quantity
    // },
    ...
    // }
    // 监测汇率
    exchangeRate: function (val, oldval) {
      console.log(this.totalFin,val)
        // this.totalFin = isNaN(this.totalFin2 * this.exchangeRate) ? 0 : this.totalFin2 * this.exchangeRate
        let v = parseInt(this.addGoodsData.price * this.addGoodsData.quantity * this.addGoodsData.rate)*0.01 * val
        this.totalFin = isNaN(v) ? 0 || this.totalFin : v
      // isNaN(totalFin*taxAllInfo2.exchangeRate)?0:totalFin*taxAllInfo2.exchangeRate
    }
  },
  mounted () {
    let _this = this
    ...
    $('#goods').delegate('h3>.icon-del', 'click', function () {
      ...
      let goodsTotalPrice = $(this).next().next().val()
      let goodsRate = $(this).next().next().next().val()
      _this.$http.get('/api/product/delete?id=' + goodsId)
        .then(res => {
          if (res.data.status === 200) {
            ...
            _this.totalFin -= parseInt(goodsTotalPrice * goodsRate * 0.01)
            // _this.totalFin -= (goodsTotalPrice*goodsRate)
            console.log('222',_this.totalFin)
    ...
    $('.add-fapiao').delegate('.icon-del', 'click', function () {
      ...
      let invoiceMoneys = $(this).next().next().val()
      _this.$http.get('/api/invoice/delete?id=' + invoiceId)
        .then(res => {
          if (res.data.status === 200) {
            ...
            $(this).parent().remove()
            // 计算发票总金额
            _this.totalInvoice -= Number(invoiceMoneys)
            // 计算发票数量
    ...
    $('.pic3').delegate('span.del2', 'click', function () {
       ...
       console.log('iii',_this.receiptImgss)
        ...
        console.log('mmm', this.receiptImgss.length)
    })
   ...
   // 删除发票凭证
    ...
    this.getProduct()
    // 获取大图
    $('.piaoju img').click(function(){
      _this.bigImgSrc = $(this)[0].src
    ...
    // 日期处理
    if ( this.taxAllInfo2.declareTime) {
      this.taxAllInfo2.declareTime = this.dateFormat(this.taxAllInfo2.declareTime)
    } else {
      this.taxAllInfo2.declareTime = ''
    }
    //
  },
  methods: {
    ...
    addGoods () {
      let _this = this
      var tol = parseInt($('#totalPrice').text())
      // 调添加商品的接口
      this.$http.post('/api/product/add', {'name': _this.productName, 'hsNumber': this.hsNumber, 'price': _this.taxAllInfo2.price, 'rate': _this.rate, 'quantity': _this.taxAllInfo2.quantity, 'totalPrice': tol})
        .then(res => {
          ...
          if (res.data.status === 200) {
            ...
            let totalPrice = tol
        // 添加标题
          let htmlImg = `<img src="static/img/msg_3.png" class="icon-del"> <input type="hidden" value="${addGoodsData.id}"/> <input type="hidden" value="${addGoodsData.totalPrice}"/><input type="hidden" value="${addGoodsData.rate}"/>`
          ...
          // 计算最大退税融资额
           // 计算最大退税融资额
           // isNaN(totalFin*taxAllInfo2.exchangeRate)?0:totalFin*taxAllInfo2.exchangeRate
          _this.totalFin += parseInt(_this.addGoodsData.price * _this.addGoodsData.quantity * _this.addGoodsData.rate)*0.01
          
          // _this.totalFin += _this.totalFin2
          // _this.totalFin2 = 0
    ...
    //   this.invoiceInfoList.forEach(function(item, index) {
    //     _this.saveInTol += parseInt(item.invoiceMoney)
    //     alert(item.invoiceMoney)
    //   })
    //   this.saveInLen = this.invoiceInfoList.length
    //   // alert(_this.saveInTol)
    // },
    // 新增发票号码及金额
    addFapiao () {
      let _this = this
      let params = {
        'invoiceNumber': this.taxAllInfo2.invoiceNumber,
        'createTime': this.taxAllInfo2.createTime,
        'invoiceMoney': this.taxAllInfo2.invoiceMoney
      }
      if (this.taxAllInfo2.invoiceMoney && !isNaN(this.taxAllInfo2.invoiceMoney)) {
        ...
        .then(res => {
          if (res.data.status === 200) {
            ...
            let html3 = `
            <div>
              发票号码：${invoiceDatas2.invoiceNumber}&nbsp; &nbsp;发票金额：${invoiceDatas2.invoiceMoney} <img src="static/img/msg_3.png" class="icon-del"><input type="hidden" id="v1" value="${invoiceDatas2.id}"><input type="hidden" id="v2" value="${invoiceDatas2.invoiceMoney}">
            </div>
          `
            ...
            _this.invoiceIdsString = _this.invoiceIds.join(',')
            // 计算发票总金额
            _this.totalInvoice += Number(_this.invoiceDatas.invoiceMoney)
            _this.saveInTols = 0
            // 计算发票数量
            
            _this.invoiceQuantity = $('#addFapiaos>div').length
            // 发票内容清空
            _this.taxAllInfo2.invoiceNumber = ''
            _this.taxAllInfo2.createTime = ''
            _this.taxAllInfo2.invoiceMoney = 0
    ...
    saveProductIds () {
      let _this = this
      _this.productsList.forEach(function(c, index) {
        _this.idssArr.push(c.id)
      })
      _this.idss = _this.idssArr.join(',')
      console.log('999998',_this.idss)
    },
    // 获取发票ids
    saveInvoices () {
      let _this = this
      _this.invoiceInfoList.forEach(function(c, index) {
        _this.indssArr.push(c.id)
      })
      _this.indss = _this.indssArr.join(',')
      console.log('999998',_this.indss)
    },
    // 下一步
    goApp2 () {
      let _this = this
      ...
      // } else {
        ...
        let params = {
          ...
          'ids': _this.idss? _this.idss + ',' + _this.ids :  _this.ids,
          'invoice': _this.indss? _this.indss +',' + _this.invoiceIdsString : _this.invoiceIdsString,
      ...
      if(_this.idss? _this.idss + ',' + _this.ids :  _this.ids !== '' && _this.indss? _this.indss +',' + _this.invoiceIdsString : _this.invoiceIdsString !== '' && parseInt(_this.earningsV) + parseInt(_this.allInfo.earnings) !== '') {
    ...
    allInfos () {
      ...
      this.allInfo = {
          'id': this.id ? this.id : '',
          'contract': this.taxAllInfo2.contract,
          'customsDecl' : this.taxAllInfo2.customsDecl,
          'passState': this.taxAllInfo2.passState,
          'declareTime': this.taxAllInfo2.declareTime,
          'refundTax': this.totalFin,
          'declareSum': this.taxAllInfo2.declareSum,
          'factoryId': parseInt(this.factoryId),
          'settlement': this.taxAllInfo2.settlement,
          'earnings': this.taxAllInfo2.earnings,
          'invoiceCode': this.taxAllInfo2.invoiceCode,
          'invoiceQuantity': this.invoiceQuantity,
          'totalInvoice' : this.taxAllInfo2.totalInvoice ? parseInt(this.taxAllInfo2.totalInvoice) + parseInt(this.totalInvoice) : this.totalInvoice,
          'customsDeclImg': this.imgsSrc1 || this.taxAllInfo2.customsDeclImg,
          'earningsImg': this.imgsSrc2 || this.taxAllInfo2.earningsImg,
          'transferImg': this.imgsSrc3 || this.taxAllInfo2.transferImg,
          'receiptImg': this.imgsSrc4File || this.taxAllInfo2.receiptImg,
    ...
    shouhui () {
      let _this = this
      _this.factoryId = 1 // _this.factoryId
    ...
    getDatasInfo () {
      ...
      this.$http.get('/api/refundapply/select/bycondition?id=' + id)
        .then(res => {
          if (res.data.status === 200 && res.data.refundApply) {
            _this.taxAllInfoAll = res.data
            _this.invoiceInfoList = res.data.InvoiceInfoList
            _this.taxAllInfo2 = res.data.refundApply
            _this.productsList = res.data.ProductList
            ...
            // 计算保存列表的发票总金额
            _this.invoiceInfoList.forEach(function(item, index) {
               _this.saveInTols += parseInt(item.invoiceMoney)
               console.log(item.invoiceMoney)
            })
            _this.totalInvoice = _this.saveInTols || 0
            // 计算保存列表的发票数量
            this.saveInLen = this.invoiceInfoList.length
            // 设置报关单日期
            this.taxAllInfo2.declareTime = this.dateFormat(res.data.refundApply.declareTime)
            // 获取选择的工厂类型
            this.userType = this.taxFactory.type-1
            this.factoryId = this.taxFactory.id
            if (this.userType==0) {
              this.loanEntName = this.taxFactory.id
            } else {
              this.outEntName = this.taxFactory.id
            }
            // 汇率
            this.exchangeRate = this.taxAllInfo2.exchangeRate
            //获得商品总额
            // this.productsList.forEach(function (item, index) {

            //   _this.totalFin2 += item.totalPrice * item.rate * 0.01
            // })
            // 获取最大退税融资额
            this.totalFin = this.taxAllInfo2.refundTax
            // 获取商品h编码
            // this.hsNumber = this.productsList.hsNumber
            // 商品名称
            this.productName = this.taxAllInfo2.productName
          }
        })
    },
    // 待提交
    ...
    getRate (_hsNumber) {
      let _this = this
      this.$http.get('/api/product/select/tsl?code=' + _hsNumber)
        .then(res => {
          if(res.data.status === 200 && res.data.result && res.data.result.length > 0) {
            console.log(res.data.result)
            let datas = res.data.result[0]
            this.rate = datas.tsl
            this.productName = datas.name
          } else {
             _this.$alert('此商品SH编码错误或不存', '提示框', {
                confirmButtonText: '确定'
             })
          }
    ...
    // 汇率设置退税额
    getExchangeRage (val) {
      this.totalFin = this.totalFin * val
      alert(this.totalFin)
    }
  }
})
...
<style type="text/css">
  ...
  .apply .company-info input[type="text"]{
    width:169px;
  }
