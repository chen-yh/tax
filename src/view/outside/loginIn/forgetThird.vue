        ...
        <div class="forget-cont c-w1200">
            ...
            <div class="forget-content">
                ...
                <div class="verification">
                    <input type="password" placeholder=请输入新密码 class="password1">
                    <input type="password" placeholder=重新输入新密码 class="password2">
...
export default {
  ...
  methods: {
    nextSecond () {
      ...
      var _this = this
      // 1、请求授信额度接口
      this.$http.post('/api/user/forget', {
        mobile: phone,
        passWord: password
      }).then(function (res) {
        // if (res.body.code == 200) {
        _this.$router.push({name: 'outForgetPasswordFour'})
        // }
