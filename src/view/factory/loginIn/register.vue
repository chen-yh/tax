    ...
    <div class="register-main">
        ...
        <div class="register-msg">
            ...
            <div class="registerType">
                <div class="p">
                    <span class="exportCompany" id="exportCompany" @click="chooseType()"><b></b></span>  
                    <label for="exportCompany">出口企业 </label>
                </div>
                <div class="p">
                    <span class="inCompany" id="inCompany"  @click="chooseType()"><b></b> </span> 
                    <label for="inCompany">进口企业</label>
                </div>
                <div class="p">
                    <span class="inCompany" id="otherCompany" @click="chooseType()"><b></b> </span> 
